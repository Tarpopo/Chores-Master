...
public static class Statistics
{
    ...
    public static bool TutorialIsCompleted
    {
        get
        {
            return PlayerPrefs.GetInt(Constants.PlayerPrefsKeyNames.TUTORIAL_COMPLETED, 0) == 1;
        }
        set
        {
            PlayerPrefs.SetInt(Constants.PlayerPrefsKeyNames.TUTORIAL_COMPLETED, value ? 1 : 0);
            PlayerPrefs.Save();
        }
    }
